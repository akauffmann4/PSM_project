...
object align {
    ...
    def main(args: Array[String]) : Unit = {
      ...
      val meshFiles = new java.io.File("C:/Users/audek/psm/datasets/challenge-data/challengedata/full-femurs/meshes/").listFiles
      ...
      val reference = new java.io.File("C:/Users/audek/psm/data/femur.stl")
      val toAlign : Array[TriangleMesh[_3D]] = meshes

      val refLandmarks: Seq[Landmark[_3D]] =
        LandmarkIO.readLandmarksJson3D(new java.io.File("C:/Users/audek/psm/data/femur.json")).get

      /*val landmarks: Array[Seq[Landmark[_3D]]] =
        LandmarkIO.readLandmarksJson3D(new java.io.File("C:/Users/audek/psm/datasets/challenge-data/challengedata/full-femurs/landmarks/").listFiles).get
      */
      var landmarksFiles = new java.io.File("C:/Users/audek/psm/datasets/challenge-data/challengedata/full-femurs/landmarks/").listFiles
      //var refLandmarks = new java.io.File("C:/Users/audek/psm/data/femur.json")
      ...
      val alignedMeshes = toAlign.map { mesh =>
        ...
        i+=1
        val meshView = ui.show(dsGroup2, mesh, "meshAligned")
      }
